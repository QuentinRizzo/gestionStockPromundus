        ...
        <div class="row mx-auto mt-1 box-descProd-bOffice">
            <div class="col-lg-12 text-center h-100">
                <div class="box-detailtext mt-2 mb-5 mx-auto w-100">
                    ...
                    <div class="row">
                        <form class="col-lg-6 mx-auto mt-2" action="../public/index.php?page=20" method="post">
                            <input type="hidden" name="id_messages" value="<?php echo $messageExiste['id_message'] ?>">
