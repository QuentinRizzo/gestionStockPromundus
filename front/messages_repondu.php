...
$messageExiste = recupListeMessagesRepondu($pdo);
?>
<section class="intro mt-5 mb-5">
    ...
    <div class="container-fluid">
        ...
        if (isset($_GET['sucess'])) {
            ...
            if ($_GET['sucess'] == 'ok') {
                echo '<p class="text-success text-center">Le Devis à été ajouter avec succès ! </p>';
            }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <form action="../controler/traitement_message_repondu.php" method="post" onsubmit="return confirm('Voulez-vous vraiment Supprimer le message ?');">
                                                    <input type="hidden" name="id_messages" value="<?php echo $msg['id_message']; ?>">
                                                    <input type="hidden" name="action" value="supprimerMessage">
                                                    <button type="submit" class="btn btnDesAjouts  btn-sm me-1" data-mdb-toggle="tooltip" title="Supprimer le Message">
                                                ...
                                                <form action="../controler/traitement_message_archiver.php" method="post" onsubmit="return confirm('Voulez-vous vraiment Archiver le message ?');">
                                                    ...
                                                    <button type="submit" class="btn btn-sm btnDesAjouts  me-1" data-mdb-toggle="tooltip" title="Archiver le Message">
                                                        <i class="bi bi-archive fs-4"></i>
                                                    </button>
                                                </form>

                                                <form action="../public/index.php?promundus=DetailMessageReponduPromundus" method="post">
                                                    <input type="hidden" name="id_messages" value="<?php echo $msg['id_message']; ?>">
