                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                <form action="../controler/traitement_delete_message.php" method="post" onsubmit="return confirm('Voulez-vous vraiment Supprimer le message ?');">
                                                ...
                                                <form action="../public/index.php?promundus=DetailMessageArchiverPromundus" method="post">
                                                    <input type="hidden" name="id_messages" value="<?php echo $msg['id_message']; ?>">
